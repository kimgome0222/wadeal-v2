...
export function HeartIcon({
  ...
  return (
    ...
    >
      <path
        d="M12 20s-7.5-4.6-9.2-9.3C1.5 7.1 3.7 4 7.2 4c2 0 3.6 1 4.8 2.6C13.2 5 14.8 4 16.8 4c3.5 0 5.7 3.1 4.4 6.7C19.5 15.4 12 20 12 20Z"
        stroke="currentColor"
        strokeWidth="2"
...
export function BellIcon({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path
        d="M12 3a5 5 0 0 0-5 5v2.1c0 .5-.2 1-.5 1.4L5 14h14l-1.5-2.5c-.3-.4-.5-.9-.5-1.4V8a5 5 0 0 0-5-5Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinejoin="round"
      />
