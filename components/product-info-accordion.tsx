...
const infoSections = [
  {
    id: "shipping",
    title: "배송 정보",
    body: "판매 종료 후 2~3일 내 출고됩니다. 제주/도서 산간 지역은 추가 배송비가 발생할 수 있어요.",
  },
  {
    id: "refund",
    title: "교환/환불 안내",
    body: "상품 수령 후 7일 이내 미개봉 상태에서 교환·환불이 가능합니다. 일괄 주문 특성상 판매 종료 후 단순 변심 환불은 제한될 수 있어요.",
  },
  {
    id: "group-buy",
    title: "구매 안내",
    body: "혜택 조건 충족 시 최종 가격으로 자동 결제됩니다. 판매 종료 전까지는 구매 취소가 가능해요.",
  },
];
      ...
      <div className="divide-y divide-wadeal-line">
        {infoSections.map((section) => {
          ...
          return (
            <div key={section.id}>
              <button
                className="flex w-full cursor-pointer items-center justify-between px-4 py-3.5 text-left active:bg-wadeal-surface"
