  ...
  return (
    <>
      ...
      <div
        ...
        className="cart-added-bottom-sheet fixed inset-x-0 bottom-0 z-[100] mx-auto max-w-[430px] overflow-y-auto rounded-t-[20px] bg-white px-6 pb-[max(env(safe-area-inset-bottom),20px)] pt-3 shadow-[0_-8px_24px_rgba(0,0,0,0.08)]"
