...
export function HomeQuickMenu() {
  return (
    <nav aria-label="빠른 메뉴" className="mb-5 mt-5 bg-white">
      <div className="overflow-x-auto overflow-y-visible px-6 pb-2 no-scrollbar">
        <div className="grid min-h-[168px] grid-flow-col grid-rows-2 auto-cols-[72px] gap-x-3 gap-y-3">
