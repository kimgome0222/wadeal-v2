...
const LEGAL_NOTICE =
  "본 문서는 celloh 스토리 커머스 서비스 운영을 위한 초안입니다. 실제 서비스 적용 전 반드시 법률 검토를 받아 주세요.";
  ...
  sections: [
    {
      ...
      bullets: [
        ...
        "서비스 이용: 상품 구매 내역, 알림 설정, 문의 내역, 접속 로그",
      ],
    },
    {
  ...
  sections: [
    {
      title: "1. 상품 구매 취소",
      paragraphs: [
        "판매 종료 전까지는 구매(예약) 취소가 가능합니다.",
        "판매 종료 후 가격이 확정되고 결제가 진행된 경우, 아래 환불·교환 기준에 따릅니다.",
      ],
    },
    {
      title: "2. 판매 미달",
      paragraphs: [
        "목표 구매 수량 미달 등으로 혜택가 성사되지 않은 경우, 구매 예약은 자동 취소되며 결제가 진행되지 않습니다.",
    ...
    },
    {
      title: "4. 교환",
      paragraphs: [
        "단순 변심에 의한 교환은 상품별 정책 및 일괄 주문 특성(일괄 발주 등)에 따라 제한될 수 있습니다.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "판매 종료 후 확정된 최종 금액 기준으로 환불 금액이 산정됩니다.",
      ],
    },
    {
      title: "6. 배송비",
...
export const GROUPBUY_POLICY: PolicyDocument = {
  ...
  title: "쇼핑 운영 정책",
  subtitle: "celloh 가격 확정 및 운영 방식",
  legalNotice: LEGAL_NOTICE,
  sections: [
    {
      title: "1. 셀러 상품 진행 방식",
      paragraphs: [
        "celloh 셀러 상품은 일정 기간 동안 다수의 이용자가 동일 상품을 구매하고, 판매 종료 시점의 누적 구매 수량에 따라 최종 단가가 결정되는 방식입니다.",
        "구매 시점에는 현재 누적 구매 수량 기준의 예상 단가가 안내됩니다.",
      ],
    },
    {
      title: "2. 가격 확정 방식",
      paragraphs: [
        "최종 확정 금액은 판매 종료 시점의 누적 구매 수량에 해당하는 가격 구간(티어) 단가 × 주문 수량으로 계산됩니다.",
        "판매 종료 전 구매가 증가하여 더 낮은 티어가 달성되면, 최종 확정 단가는 더 낮아질 수 있습니다.",
        "판매 종료 후에는 확정된 단가로 결제가 진행되며, 구매 시점 예상가와 최종 확정가가 다를 수 있음을 이용자가 확인·동의합니다.",
      ],
    },
    {
      title: "3. 결제 시점",
      paragraphs: [
        "구매(예약) 단계에서는 결제가 즉시 이루어지지 않을 수 있습니다.",
        "판매 종료 및 가격 확정 후, 등록된 결제수단으로 최종 확정 금액이 청구됩니다.",
        "결제 실패 시 별도 안내가 제공되며, 기한 내 결제가 완료되지 않으면 혜택가 취소될 수 있습니다.",
      ],
    },
    {
      title: "4. 배송",
      paragraphs: [
        "배송은 판매 종료, 가격 확정, 결제 완료 후 공급사 일정에 따라 순차 발송됩니다.",
    ...
    },
    {
      title: "5. 구매 제한",
      paragraphs: [
        "동일 상품에 중복 혜택가 제한될 수 있습니다.",
        "부정 구매, 허위 정보 등록, 시스템 악용이 확인될 경우 혜택가 취소될 수 있습니다.",
      ],
    },
    {
      title: "6. 고객 안내",
      paragraphs: [
        "가격 티어 변경, 인기 상품, 결제 예정 등 주요 안내는 앱 알림 또는 카카오 알림(동의 시)으로 제공될 수 있습니다.",
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "판매 종료 전·후, 제작·주문제작 상품 등은 별도 정책이 적용될 수 있습니다.",
      ],
    },
  ],
};
