export const ui = {
  btnPrimary:
    "flex h-12 w-full cursor-pointer items-center justify-center rounded-lg bg-wadeal-red text-[15px] font-black text-white active:opacity-90 disabled:cursor-not-allowed disabled:bg-gray-300",
  btnOutline:
    "flex h-11 w-full cursor-pointer items-center justify-center rounded-lg border border-wadeal-line bg-white text-sm font-black text-wadeal-ink active:bg-gray-50",
  btnKakao:
    "flex h-12 w-full cursor-pointer items-center justify-center rounded-lg bg-wadeal-kakao text-[15px] font-black text-[#3c1e1e] active:opacity-90",
